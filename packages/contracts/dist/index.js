...
export { z } from 'zod';
// 常用的Schema组合导出
import { AppIntentSchema, AIResponseSchema, IntentExecutionResultSchema } from './intents.js';
import { UserSignupSchema, UserLoginSchema, HVACDeviceCreateSchema, HVACDeviceUpdateSchema, MessageSendSchema, SystemSettingsUpdateSchema, HVACSystemStateSchema } from './business.js';
...
export const createValidator = (schema) => {
    return {
        ...
        safeValidate: (data) => schema.safeParse(data),
        isValid: (data) => schema.safeParse(data).success,
    };
};
// 常用验证器
